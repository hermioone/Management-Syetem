    ...
    <body>
                        ...
                        <div class="col-md-12 column">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if orderDTO.getOrderStatusEnums().code == 0>
        ...
        <script>
            ...
            if('WebSocket' in window) {
                websockt = new WebSocket("ws://localhost:8080/sell/webSocket");
            }else {
                alert("该浏览器不支持websocket");
            }
            websockt.onopen = function (event) {
                console.log("建立连接");
            }

            websockt.onclose = function (event) {
                console.log("连接关闭");
            }
